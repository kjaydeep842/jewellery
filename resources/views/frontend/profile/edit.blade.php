...
@section('content')
    <main class="w-full flex-grow pt-8 pb-16 min-[2000px]:pt-20 min-[2000px]:pb-32 bg-[#FDFBF7] flex justify-center">
        <div
            class="flex flex-col lg:flex-row justify-center items-start p-[20px] md:p-[40px] gap-[20px] max-w-[1920px] w-full self-stretch">

            <!-- Sidebar -->
            @include('frontend.profile.partials.sidebar')

            <!-- Main Content Form -->
            <div class="flex-grow p-4 md:p-10 bg-white rounded-[10px] shadow-sm">
                ...
                <!-- Profile Pic Upload -->
                <div
                    class="relative w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mb-10 group cursor-pointer overflow-hidden border border-gray-200">
                    <i class="fa-regular fa-user text-3xl text-gray-400"></i>
                    <button
                        class="absolute bottom-1 right-1 bg-[#CBA65A] text-white w-6 h-6 rounded-full flex items-center justify-center hover:bg-[#a68541] transition-colors border border-white shadow-sm z-10">
