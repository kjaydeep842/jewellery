    ...
    <section class="max-w-[1240px] mx-auto px-4 md:px-6 -mt-[140px] md:-mt-[160px] relative z-10 mb-20">
        <div
            ...
            <div class="p-6 md:px-16 md:py-14 lg:w-[65%] xl:w-[68%]">
                ...
                @if(session('success'))
                <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-6 font-['Outfit']" role="alert">
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="first_name" value="{{ old('first_name') }}" placeholder="Name*"
                                class="border @error('first_name') border-red-500 @else border-[#EBEBEB] @enderror rounded-[8px] px-5 py-[16px] text-[15px] focus:outline-none focus:border-[#CBA65A] bg-white placeholder-[#9C9C9C] font-['Outfit']">
                            @error('first_name')
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="last_name" value="{{ old('last_name') }}" placeholder="Name*"
                                class="border @error('last_name') border-red-500 @else border-[#EBEBEB] @enderror rounded-[8px] px-5 py-[16px] text-[15px] focus:outline-none focus:border-[#CBA65A] bg-white placeholder-[#9C9C9C] font-['Outfit']">
                            @error('last_name')
                            <span class="text-red-500 text-xs font-['Outfit']">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter Your Email"
                                class="border @error('email') border-red-500 @else border-[#EBEBEB] @enderror rounded-[8px] px-5 py-[16px] text-[15px] focus:outline-none focus:border-[#CBA65A] bg-white placeholder-[#9C9C9C] font-['Outfit']">
                            @error('email')
                            <span class="text-red-500 text-xs font-['Outfit']">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="font-['Outfit'] text-[16px] font-bold text-[#1A1A1A]">Contact
                                Details</label>
                            <div
                                class="flex items-center border @error('phone_number') border-red-500 @else border-[#EBEBEB] @enderror rounded-[8px] overflow-hidden bg-white h-[54px]">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea name="message" rows="6" placeholder="Enter Your Message"
                            class="border @error('message') border-red-500 @else border-[#EBEBEB] @enderror rounded-[8px] px-5 py-5 text-[15px] focus:outline-none focus:border-[#CBA65A] resize-none bg-white placeholder-[#9C9C9C] font-['Outfit']">{{ old('message') }}</textarea>
                        @error('message')
                        <span class="text-red-500 text-xs font-['Outfit']">{{ $message }}</span>
                        @enderror
                    </div>
