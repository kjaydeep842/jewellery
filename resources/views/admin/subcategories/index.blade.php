...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-zinc-800">Subcategories</h1>
                ...
                <tbody class="divide-y divide-zinc-100">
                    @foreach($subcategories as $subcategory)
                        <tr class="hover:bg-zinc-50/50 transition-colors">
                            <td class="p-4 font-medium text-zinc-700">{{ $subcategory->name }}</td>
                            <td class="p-4 text-zinc-500">{{ $subcategory->category->name }}</td>
                            <td class="p-4">
