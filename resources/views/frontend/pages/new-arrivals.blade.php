...
<section class="w-full bg-[#EFE4D6] py-8 md:py-10">
    <div class="max-w-[1920px] mx-auto px-4 text-center">
        <h1
            class="w-[456px] h-[88px] mx-auto font-['Outfit'] font-medium text-[70px] leading-[88px] text-[#826230] mb-4 whitespace-nowrap">
            New Arrivals</h1>
        <p class="max-w-2xl mx-auto text-sm md:text-base font-['Inter'] leading-relaxed">
            Discover our latest collection of exquisite jewellery. From timeless classics to modern designs, explore the newest additions to our catalog.
        </p>
    </div>
</section>
...
<main class="w-full max-w-[1920px] min-[2000px]:max-w-[2400px] mx-auto px-3 lg:px-8 py-8 font-['Outfit'] flex flex-col gap-2.5">
        ...
        <div class="flex flex-col gap-1">
            <div class="text-sm text-gray-500">
                <a href="{{ route('home') }}" class="hover:text-amber-600 cursor-pointer">Home</a> / <span
                    class="text-gray-800 font-medium">New Arrivals</span>
            </div>
    ...
    <div class="w-full flex flex-col lg:flex-row lg:items-start gap-8 mt-4">
        ...
        @include('frontend.partials.filter-sidebar', ['route' => 'page.new-arrivals'])
    ...
    $(document).ready(function() {
        ...
        window.updateProducts = function() {
            ...
            debounceTimer = setTimeout(function() {
                ...
                const baseUrl = "{{ route('page.new-arrivals', [], false) }}";
