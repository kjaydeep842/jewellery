            ...
            <div class="w-full max-w-full lg:max-w-[1143px] mx-auto" style="border-radius: 0;">
                <div id="image-zoom-container" class="relative w-full bg-white overflow-hidden cursor-zoom-in"
                    ...
                    <div id="main-media-container" class="w-full h-full leading-none hidden sm:block">
                        ...
                        @if($pMainImagePath)
                            @if($isMainVideo)
                            <video id="main-image" src="{{ $pMainImagePath }}" autoplay loop muted playsinline class="absolute inset-0 w-full h-full object-contain p-4 sm:p-6 md:p-8 lg:p-10 transition-transform duration-100 ease-out pointer-events-none origin-center"></video>
                            @else
            ...
            <div class="w-full max-w-full lg:max-w-[1143px] mx-auto">
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 gap-[10px]">
                    ...
                    <div class="thumbnail-item cursor-pointer bg-white transition-all duration-200 hover:border-2 hover:border-[#CBA65A] rounded-lg"
                        ...
                        <div class="thumb-media-container w-full h-full flex items-center justify-center p-2 sm:p-3 pointer-events-none">
                            @if($isThumbVideo)
                            <video src="{{ $image->image_path }}" class="object-contain w-full h-full" autoplay loop muted playsinline></video>
                            @else
        ...
        <div id="content-about" class="bg-[#FAF8F1] w-full max-w-[1120px] mx-auto transition-opacity duration-300">
            <div
                ...
                <div
                    ...
                    @if($aMainImagePath)
                        @if($isVideo)
                        <video src="{{ $aMainImagePath }}" autoplay loop muted playsinline class="w-full h-full object-contain mix-blend-multiply"></video>
                        @else
