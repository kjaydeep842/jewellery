...
@section('content')
    ...
    <section class="w-full bg-[#EFE4D6] py-8 md:py-10">
        <div class="w-full px-4 md:px-8 text-center">
            <h1 class="text-3xl md:text-5xl font-['Outfit'] font-medium text-[#5C4522] mb-4">Tattsvi's Favourite</h1>
    ...
    <main class="w-full px-4 md:px-6 py-8 font-['Outfit'] flex flex-col gap-2.5">
        ...
        <div class="flex flex-row justify-between items-center mb-4 relative z-30 gap-2 lg:hidden">
            ...
            <button id="mobile-filter-btn" class="flex items-center gap-2 text-gray-800 font-medium border border-gray-300 px-4 py-2.5 rounded-md hover:bg-gray-50 transition-colors whitespace-nowrap">
        ...
        <div class="flex-grow">
            ...
            <div id="products-container">
                    ...
                    <!-- Grid Container -->
                    <div id="products-container">
                        @include('frontend.pages.partials.tattsvisfavourite-grid')
                    </div>
                </div>
