...
<section class="w-full bg-[#EFE4D6] py-8 md:py-10">
    <div class="w-full px-4 md:px-8 text-center">
        <h1 class="text-3xl md:text-5xl font-['Outfit'] font-medium text-[#5C4522] mb-4">New Arrivals</h1>
        <p class="max-w-2xl mx-auto text-sm md:text-base text-gray-700 font-['Inter'] leading-relaxed">
            Be the first to explore our latest pieces, fresh from the workshop and designed for modern elegance.
        </p>
    </div>
</section>
            ...
            <div class="p-5 lg:p-0">
                ...
                <form id="filterForm" action="{{ route('page.new-arrivals') }}" method="GET">
                    ...
                    <div class="hidden lg:flex items-center justify-between mb-4 font-medium text-lg">
                        ...
                        <a href="{{ route('page.new-arrivals') }}" class="text-xs text-amber-600 hover:underline">Clear All</a>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Accordion Logic Removed (Now Global in Master)
});
</script>
@endsection