...
<h1 class="text-3xl font-premium font-bold mb-6 text-zinc-900">Edit Unit: {{ $unit->name }}</h1>
    ...
    <form action="{{ route('admin.units.update', $unit->id) }}" method="POST">
        ...
        <div class="mb-8">
            ...
            <label class="inline-flex items-center cursor-pointer">
                <input type="checkbox" name="status" value="1" class="sr-only peer" {{ old('status', $unit->status) ? 'checked' : '' }}>
