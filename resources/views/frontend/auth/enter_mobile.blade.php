            ...
            <div class="w-full max-w-[420px] flex flex-col items-center mt-4">
                ...
                <form id="mobile-form" class="w-full">
                    ...
                    <div class="w-full relative mb-6">
                        <div
                            class="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-2 border-r border-gray-300 pr-3 h-[24px]">
                            <img src="https://flagcdn.com/w20/in.png" alt="India"
                                class="w-5 h-auto rounded-[2px] border border-gray-200">
                            <span class="font-['Outfit'] text-[#1A1A1A] text-sm">+91</span>
                        </div>
                        <input type="tel" id="phone" name="phone" placeholder="Phone Number" maxlength="10"
                            class="w-full h-[54px] bg-white border border-gray-200 rounded-[4px] pl-[100px] pr-4 outline-none focus:border-[#CBA65A] transition-colors font-['Outfit'] text-[#1A1A1A] placeholder-gray-400 text-[15px] shadow-sm"
                            required>
                    </div>
