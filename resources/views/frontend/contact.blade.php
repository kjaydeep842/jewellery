    ...
    <div class="bg-[#F9F5EB] min-h-screen py-20 px-4">
        <div class="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-zinc-100">
            ...
            <p class="text-zinc-500 mb-8 text-sm md:text-base leading-relaxed">
                Do you have a question? A complaint? Or need any help to choose the right product from Tattsvi? Feel free to
                contact us.
            </p>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            <select name="phone_code"
                                class="bg-white border border-zinc-200 border-r-0 rounded-l-lg px-3 py-3 text-zinc-700 bg-[center_right_0.5rem] focus:outline-none focus:ring-0 focus:border-zinc-200 w-24">
