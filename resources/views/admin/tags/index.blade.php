...
<div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
    <h1 class="text-2xl sm:text-3xl font-premium font-bold text-zinc-900 tracking-wide">Tags</h1>
...
<div class="bg-white border border-zinc-100 rounded-xl shadow-lg shadow-zinc-200/50 overflow-x-auto animate-enter p-4">
    ...
    <div class="mt-4 p-4 border-t border-zinc-100 bg-zinc-50 rounded-xl">
        {{ $tags->links() }}
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#tagsTable').DataTable({
                responsive: false,
                autoWidth: false,
                paging: false, // Disable DataTable paging as we use Laravel pagination
                info: false, // Disable DataTable info as it only shows the current page's count
                language: {
                    search: "_INPUT_",
