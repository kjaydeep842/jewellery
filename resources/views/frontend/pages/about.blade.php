    ...
    <section class="max-w-[1440px] mx-auto ">
        <div class="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <div class="flex justify-center">
                <div class="w-full max-w-[445px] max-h-[680px] aspect-[3/4] rounded-[200px] overflow-hidden relative">
                    <!-- <img src="assets/meet_founder.png" alt="Founder" class="w-full h-full object-cover"> -->
                    @if($story['image'])
                    <img src="{{ asset('storage/' . $story['image']) }}" alt="{{ $story['title'] }}" class="w-full h-full object-cover">
                    @else
                    <img src="{{ asset('assets/color_truck.png') }}" alt="Feature" class="h-full w-auto opacity-80">
                    @endif
                </div>
            </div>
    ...
    <section class="max-w-[1440px] mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- <div class="flex flex-col items-center justify-center p-8 text-center rounded-2xl"
                style="background: linear-gradient(180deg, #F9E4E4 0%, #FFFFFF 100%);">
                <div class="flex justify-center mb-6">
                    <img src="assets/color_truck.png" alt="Fast Delivery" class="h-[40px] w-auto">
                </div>
