...
<section class="bg-transparent pt-0 pb-4 md:pt-0 md:pb-8 px-6">
  <div class="max-w-[1600px] min-[2000px]:max-w-full mx-auto">
    ...
    <div id="diamond-shapes-container"
      class="flex overflow-x-auto snap-x snap-mandatory gap-4 md:gap-[10px] justify-start md:justify-between items-center no-scrollbar pb-4 w-full max-w-[1920px] mx-auto px-4 lg:px-[273px]">
      ...
      <div
        ...
        class="flex flex-col items-center group cursor-pointer gap-2 md:gap-4 flex-shrink-0 snap-start min-w-[80px] sm:min-w-[100px]">
...
<section class="bg-[#FAF9F6] pt-8 pb-4 md:pt-16 md:pb-8 px-6">
  <div class="max-w-[1600px] min-[2000px]:max-w-full mx-auto">
    ...
    <div
      class="flex flex-nowrap justify-start overflow-x-auto no-scrollbar gap-2 sm:gap-3 mb-8 w-full md:mb-12 snap-x px-1">
      <button onclick="filterProducts('all', this)"
        class="category-btn active flex-shrink-0 px-5 py-2 md:px-10 md:py-2 min-[2000px]:px-12 min-[2000px]:py-4 font-['Outfit'] md:gap-0 bg-black text-white border border-gray-200 text-[11px] md:text-sm min-[2000px]:text-xl tracking-widest rounded-full hover:bg-black hover:text-white snap-center transition-colors whitespace-nowrap"
        ...
        if (productGrid) {
          ...
          fetch(url, {
            ...
            .then(data => {
              ...
              // Hide/Show Explore All Button based on count
              const exploreBtn = document.getElementById('exploreAllForm');
              if (exploreBtn) {
                if (data.count === 0) {
        ...
        if (productSlider) {
          ...
          fetch(url, {
            ...
            .then(data => {
              ...
              // Hide/Show Slider Explore All Button based on count
              const sliderExploreBtn = document.getElementById('sliderExploreAllForm');
              if (sliderExploreBtn) {
                if (data.count === 0) {
                  sliderExploreBtn.classList.add('hidden');
                } else {
                  sliderExploreBtn.classList.remove('hidden');
                }
              }
      ...
      <div
        ...
        <div class="relative w-full aspect-[0.6] rounded-[40px] overflow-hidden gap-2">
          <img src="{{ asset('storage/' . $category->image) }}"
            class="absolute left-1/2 -translate-x-1/2 w-[82%] h-[75%] object-cover object-bottom transition-transform duration-500 drop-shadow-lg rounded-t-[40px]"
            alt="{{ $category->name }}">
...
<section class="bg-transparent pt-4 pb-8 md:pt-8 md:pb-0 overflow-hidden relative w-full max-w-[100vw] z-20">
  ...
  <div class="text-center mb-0 relative z-30">
    <div class="flex items-center justify-center gap-1 md:gap-4 min-[3000px]:gap-8 mb-2">
      <img src="assets/Design_new.png" class="h-3 md:h-5 min-[3000px]:h-8 w-auto object-contain" alt="decoration">
      <span style="font-family: 'Alexandria'"
        class="font-Alexandria text-[#5C4522] text-sm md:text-2xl min-[2000px]:text-4xl min-[3000px]:text-6xl tracking-normal font-normal whitespace-nowrap">Express
        Your Identity with</span>
      <img src="assets/Design_new.png" class="h-3 md:h-5 min-[3000px]:h-8 w-auto object-contain transform scale-x-[-1]" alt="decoration">
    </div>
    <h2 style="font-family: 'Outfit'"
      class="font-Outfit text-[#CBA65A] text-3xl md:text-[54px] min-[2000px]:text-[80px] min-[3000px]:text-[120px] font-medium leading-tight">
      Our Unique Style
    </h2>
  </div>
  ...
  <!-- Lens Grid Wrapper -->
  <div
    class="relative w-full h-[250px] md:h-[750px] lg:h-[850px] min-[2000px]:h-[1200px] min-[3000px]:h-[1500px] z-10 -mt-8 md:-mt-48 min-[2000px]:-mt-80 min-[3000px]:-mt-[350px]">
    <!-- Top Curve Mask (White) -->
    <div
      class="absolute -top-[100px] md:-top-[698px] min-[1800px]:-top-[660px] min-[2000px]:-top-[950px] min-[3000px]:-top-[1600px] left-1/2 -translate-x-1/2 w-[120%] md:w-[2416px] min-[1800px]:w-[2600px] min-[2000px]:w-[150%] min-[3000px]:w-[200%] h-[150px] md:h-[918px] min-[2000px]:h-[1300px] min-[3000px]:h-[2000px] max-w-none bg-white rounded-b-[100%] md:rounded-b-[50%] z-20 pointer-events-none">
    </div>
    ...
    <div
      class="absolute -bottom-[100px] md:-bottom-[698px] min-[1800px]:-bottom-[680px] min-[2000px]:-bottom-[950px] min-[3000px]:-bottom-[1600px] left-1/2 -translate-x-1/2 w-[120%] md:w-[2416px] min-[1800px]:w-[2600px] min-[2000px]:w-[150%] min-[3000px]:w-[200%] h-[150px] md:h-[918px] min-[2000px]:h-[1300px] min-[3000px]:h-[2000px] max-w-none bg-white rounded-t-[100%] md:rounded-t-[50%] z-20 pointer-events-none">
    </div>
  </div>

  <!-- Button -->
  <div class="absolute bottom-4 md:bottom-[60px] min-[3000px]:bottom-[100px] left-1/2 -translate-x-1/2 z-30">
    <button
      class="w-[150px] h-[45px] md:w-[195px] md:h-[60px] min-[2000px]:w-[300px] min-[2000px]:h-[80px] min-[3000px]:w-[450px] min-[3000px]:h-[110px] bg-[#0D0D0E] text-white hover:bg-gray-800 rounded-[200px] font-Outfit tracking-widest text-xs md:text-sm min-[2000px]:text-2xl min-[3000px]:text-4xl transition-all flex items-center justify-center gap-[10px] min-[3000px]:gap-4 group shadow-lg px-[26px]">
      View More
      <img src="assets/ic_back_2_white.png"
        class="h-3 md:h-4 min-[2000px]:h-6 min-[3000px]:h-10 w-auto transform group-hover:translate-x-1 transition-transform" alt="arrow">
    </button>
  </div>
      ...
      <div class="flex-1 flex flex-col  justify-center space-y-8 lg:pl-10">
        ...
        <div class="space-y-6 max-w-lg mx-auto lg:mx-0 xl:mx-auto">
          ...
          <div class="flex items-center gap-5">
            ...
            <div class="text-left">
              ...
              <p style="font-family: 'Outfit'"
                ...
                Value that reflects purity. Grab this piece at just
                ₹{{ number_format($bestSellerProduct->discount_price, 2) }}
                @else
                Value that reflects purity. Exceptional craftsmanship for
                ₹{{ number_format($bestSellerProduct->selling_price, 2) }}
                @endif
              </p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-5">
            ...
            <div class="text-left">
              <h4 style="font-family: 'Outfit'"
                class="font-Outfit text-[18px] md:text-[20px] min-[2000px]:text-3xl font-semibold text-[#0D0D0E] leading-tight mb-1">
                Certified {{ $bestSellerProduct->metal_purity ?? 'Pure' }}
                {{ $bestSellerProduct->metal_type ?? 'Gold' }}
              </h4>
              <p style="font-family: 'Outfit'"
                class="font-Outfit font-light text-[14px] md:text-[15px] min-[2000px]:text-xl text-[#5C5C5C] leading-snug">
        ...
        <div class="pt-10 text-center w-full flex flex-col items-center">
          <p style="font-family: 'Outfit'"
            ...
            Loved Beyond Trends. A
            {{ $bestSellerProduct->category ? $bestSellerProduct->category->name : 'Jewellery piece' }} that continues
            to be chosen.
          </p>
