<x-admin-guest-layout>
    <div class="min-h-screen flex bg-gray-900">
        ...
        <div class="hidden lg:flex w-1/2 bg-cover bg-center relative"
            style="background-image: url('https://images.unsplash.com/photo-1599643478518-17488fbbcd75?q=80&w=2070&auto=format&fit=crop');">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center text-white p-12 text-center">
                ...
                <h1 class="text-4xl font-serif font-bold mb-4 tracking-wide text-white drop-shadow-md">Join the Elite
                </h1>
                <p class="text-lg font-light tracking-wider opacity-90 max-w-md">Begin your journey in luxury
                    management.</p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#0f172a]">
            <div class="w-full max-w-md">
                <div class="mb-8 text-center lg:text-left">
                    ...
                    <p class="text-gray-400">Join us to access exclusive features.</p>
                </div>
