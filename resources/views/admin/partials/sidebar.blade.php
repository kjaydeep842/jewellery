<aside 
    ...
    {{-- TOP SECTION --}}
    <div style="background-color: rgba(0,0,0,0.2);" class="h-20 flex items-center justify-between px-6 border-b border-zinc-800 relative">
        <div class="flex items-center space-x-3">
            ...
            <h2 class="text-xl font-bold bg-gradient-to-r from-amber-200 via-amber-400 to-amber-600 bg-clip-text text-transparent tracking-wide">
