...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/sagarkhunt/WorkSpace/Tattsvi/Developing/jewellery/public/storage' => 'string',
            ...
            'otp.length' => 'integer',
            'otp.expiry_minutes' => 'integer',
            'otp.max_attempts' => 'integer',
            'otp.rate_limit_minutes' => 'integer',
            'otp.twilio.sid' => 'NULL',
            'otp.twilio.auth_token' => 'NULL',
            'otp.twilio.phone_number' => 'NULL',
...
'auth.guards.web.provider','auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider',
...
'filesystems.disks.s3.report','filesystems.links./Users/sagarkhunt/WorkSpace/Tattsvi/Developing/jewellery/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','otp.length',
'otp.expiry_minutes','otp.max_attempts','otp.rate_limit_minutes','otp.twilio.sid','otp.twilio.auth_token',
'otp.twilio.phone_number','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'sanctum.csrf-cookie','frontend.auth.mobile','frontend.auth.send-otp','frontend.auth.verify-otp',
'frontend.auth.verify-otp.submit','frontend.auth.resend-otp','frontend.auth.logout','home','home.filter',
'faqs','page.return-exchange','contact.show','contact.submit','page.best-seller',
'page.readytostock','page.buy-it-again','page.contact','page.exhibition','page.about',
'page.faq','page.blog','page.new-arrivals','page.18kt','page.tattsvisfavourite',
'products.index.post','product.details','products.index','products.create','products.show',
'products.edit','products.update','products.destroy','wishlist.toggle','ajax.products.category',
'ajax.search.suggestions','cart.store','cart.update','cart.destroy','checkout.index',
'checkout.process','checkout.success','checkout.address','checkout.address.create','checkout.address.store',
'checkout.address.edit','checkout.address.update','checkout.select-address','checkout.payment','cart.index',
'wishlist.index','wishlist.destroy','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','orders.index','profile.edit','profile.update',
'profile.destroy','admin.login','admin.login.submit',
'admin.logout','admin.dashboard','admin.categories.index','admin.categories.create',
'admin.categories.store','admin.categories.show','admin.categories.edit','admin.categories.update','admin.categories.destroy',
'admin.subcategories.index','admin.subcategories.create','admin.subcategories.store','admin.subcategories.show','admin.subcategories.edit',
'admin.subcategories.update','admin.subcategories.destroy','admin.tags.index','admin.tags.create','admin.tags.store',
'admin.tags.show','admin.tags.edit','admin.tags.update','admin.tags.destroy','admin.products.index',
'admin.products.create','admin.products.store','admin.products.show','admin.products.edit','admin.products.update',
'admin.products.destroy','admin.brands.index','admin.brands.create','admin.brands.store','admin.brands.show',
'admin.brands.edit','admin.brands.update','admin.brands.destroy','admin.orders.index','admin.orders.create',
'admin.orders.store','admin.orders.show','admin.orders.edit','admin.orders.update','admin.orders.destroy',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.banners.index','admin.banners.create','admin.banners.store',
'admin.banners.show','admin.banners.edit','admin.banners.update','admin.banners.destroy','admin.styles.index',
'admin.styles.create','admin.styles.store','admin.styles.show','admin.styles.edit','admin.styles.update',
'admin.styles.destroy','admin.shapes.index','admin.shapes.create','admin.shapes.store','admin.shapes.show',
'admin.shapes.edit','admin.shapes.update','admin.shapes.destroy','admin.features.index','admin.features.create',
'admin.features.store','admin.features.show','admin.features.edit','admin.features.update','admin.features.destroy',
'admin.diamond_qualities.index','admin.diamond_qualities.create','admin.diamond_qualities.store','admin.diamond_qualities.show','admin.diamond_qualities.edit',
'admin.diamond_qualities.update','admin.diamond_qualities.destroy','admin.metal_colors.index','admin.metal_colors.create','admin.metal_colors.store',
'admin.metal_colors.show','admin.metal_colors.edit','admin.metal_colors.update','admin.metal_colors.destroy','admin.sizes.index',
'admin.sizes.create','admin.sizes.store','admin.sizes.show','admin.sizes.edit','admin.sizes.update',
'admin.sizes.destroy','admin.metals.index','admin.metals.create','admin.metals.store','admin.metals.show',
'admin.metals.edit','admin.metals.update','admin.metals.destroy','admin.units.index','admin.units.create',
'admin.units.store','admin.units.show','admin.units.edit','admin.units.update','admin.units.destroy',
'admin.colors.index','admin.colors.create','admin.colors.store','admin.colors.show','admin.colors.edit',
'admin.colors.update','admin.colors.destroy','admin.faqs.index','admin.faqs.create','admin.faqs.store',
'admin.faqs.show','admin.faqs.edit','admin.faqs.update','admin.faqs.destroy','admin.returns.index',
'admin.returns.create','admin.returns.store','admin.returns.show','admin.returns.edit','admin.returns.update',
'admin.returns.destroy','admin.contacts.index','admin.contacts.create','admin.contacts.store','admin.contacts.show',
'admin.contacts.edit','admin.contacts.update','admin.contacts.destroy','admin.our_stories.index','admin.our_stories.create',
'admin.our_stories.store','admin.our_stories.show','admin.our_stories.edit','admin.our_stories.update','admin.our_stories.destroy',
'admin.blogs.index','admin.blogs.create','admin.blogs.store','admin.blogs.show','admin.blogs.edit',
'admin.blogs.update','admin.blogs.destroy','admin.categories.subcategories','admin.banners.toggle','admin.styles.toggle',
'admin.features.toggle','admin.our_stories.toggle','admin.faqs.toggle','admin.returns.toggle','admin.brands.toggle',
'admin.diamond_qualities.toggle','admin.metal_colors.toggle','admin.sizes.toggle','admin.metals.toggle','admin.units.toggle',
'admin.colors.toggle','admin.settings.index','admin.settings.update','storage.local',);
...
'admin.auth.verify-email','admin.banners.create','admin.banners.edit','admin.banners.form','admin.banners.index',
'admin.brands.create','admin.brands.edit','admin.brands.index','admin.categories.create','admin.categories.edit',
'admin.categories.index','admin.colors.create','admin.colors.edit','admin.colors.index','admin.contacts.index',
'admin.dashboard','admin.diamond_qualities.create','admin.diamond_qualities.edit','admin.diamond_qualities.index','admin.faqs.create',
'admin.faqs.edit','admin.faqs.index','admin.features.create','admin.features.edit','admin.features.index',
'admin.metal_colors.create','admin.metal_colors.edit','admin.metal_colors.index','admin.metals.create','admin.metals.edit',
'admin.metals.index','admin.orders.create','admin.orders.edit','admin.orders.index','admin.orders.show',
'admin.our_stories.create','admin.our_stories.edit','admin.our_stories.index','admin.partials.footer','admin.partials.navbar',
'admin.partials.sidebar','admin.products.create','admin.products.edit','admin.products.index','admin.returns.create',
'admin.returns.edit','admin.returns.index','admin.settings.index','admin.shapes.create','admin.shapes.edit',
'admin.shapes.index','admin.sizes.create','admin.sizes.edit','admin.sizes.index','admin.styles.create',
'admin.styles.edit','admin.styles.index','admin.subcategories.create','admin.subcategories.edit','admin.subcategories.index',
'admin.tags.create','admin.tags.edit','admin.tags.index','admin.units.create','admin.units.edit',
'admin.units.index','admin.users.create','admin.users.edit','admin.users.index','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'components.admin-guest-layout','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-label','components.layouts.frontend','components.modal',
...
'front.products.index','frontend.auth.enter_mobile','frontend.auth.verify_otp','frontend.checkout.add-address','frontend.checkout.address',
'frontend.checkout.cart','frontend.checkout.layouts.app','frontend.checkout.partials.header','frontend.checkout.partials.mobile-menu','frontend.checkout.payment',
'frontend.contact','frontend.dashboard','frontend.faqs','frontend.home','frontend.layouts.app',
'frontend.layouts.master','frontend.layouts.navigation','frontend.orders.index','frontend.pages.18kt','frontend.pages.about',
'frontend.pages.best-seller','frontend.pages.blog','frontend.pages.buy-it-again','frontend.pages.contact','frontend.pages.exhibition',
'frontend.pages.faq','frontend.pages.new-arrivals','frontend.pages.partials.18kt-grid','frontend.pages.partials.best-seller-grid','frontend.pages.partials.products-grid',
'frontend.pages.partials.readytostock-grid','frontend.pages.partials.tattsvisfavourite-grid','frontend.pages.ready-to-stock','frontend.pages.readytostock','frontend.pages.return_exchange',
'frontend.pages.tattsvisfavourite','frontend.partials.footer','frontend.partials.header','frontend.partials.home_category_products','frontend.partials.home_product_slider',
'frontend.partials.home_products','frontend.product-details','frontend.products.index','frontend.products.partials.grid','frontend.products.show',
'frontend.profile.edit','frontend.profile.partials.delete-user-form','frontend.profile.partials.sidebar','frontend.profile.partials.update-password-form','frontend.profile.partials.update-profile-information-form',
'frontend.return_exchange','frontend.welcome','frontend.wishlist.index','layouts.admin','layouts.admin-auth',
'layouts.guest','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
