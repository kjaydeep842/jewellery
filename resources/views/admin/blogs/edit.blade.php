            ...
            <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="10"
                        class="w-full px-4 py-3 rounded-lg border border-zinc-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-shadow shadow-sm placeholder-zinc-400"
                        placeholder="Enter the main blog content here...">{{ old('description', $blog->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    @if($blog->image)
                    <div class="mb-4">
                        <p class="text-xs text-zinc-500 mb-2">Current Image:</p>
                        <div class="relative w-48 h-32 rounded-lg overflow-hidden border border-zinc-200 shadow-sm">
                ...
                <div class="flex items-center">
                    <label class="relative inline-flex items-center cursor-pointer group">
                        <input type="checkbox" name="status" value="1" class="sr-only peer" {{ $blog->status ? 'checked' : '' }}>
