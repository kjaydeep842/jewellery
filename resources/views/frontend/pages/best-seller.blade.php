...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateProducts() {
        ...
        .then(html => {
            ...
            // On mobile, maybe close the drawer if it was an immediate update?
            // But since we have an "Apply" button on mobile usually, we might not want to auto-close.
            // For now, let's keep it open or let user close it.
        })
        .catch(error => {
    ...
    filterForm.addEventListener('change', function(e) {
        if (e.target.classList.contains('filter-checkbox')) {
            // Only auto-update on desktop to avoid frequent reloads on mobile
