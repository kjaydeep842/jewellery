<div x-data="{ mobileMenuOpen: false }"
    ...
    <a href="{{ route('profile.edit') }}"
        ...
        <div class="flex flex-col gap-1.5 flex-grow">
            <h3
                class="font-['Outfit'] font-bold text-[#1A1A1A] text-[16px] leading-tight group-hover:text-[#CBA65A] transition-colors">
                {{ Auth::user()->name ?: 'User' }}
            </h3>
            ...
            <div class="mt-1 space-y-1.5">
                <div class="h-1 w-full bg-[#EADDCC]/40 rounded-full overflow-hidden">
                    <div class="h-full bg-[#CBA65A] rounded-full transition-all duration-1000 ease-in-out"
                        style="width: {{ $percentage }}%"></div>
                </div>
                <p class="text-[12px] text-[#7D7D7D] font-['Outfit'] font-normal leading-tight">
            ...
            <ul class="space-y-4">
                <li>
                    <a href="{{ route('page.terms') }}"
                        class="flex items-center justify-between w-full h-[68px] px-4 rounded-[10px] text-[#1A1A1A] font-['Outfit'] text-[15px] font-medium group transition-colors box-border border {{ request()->routeIs('page.terms') ? 'bg-[rgba(219,179,88,0.1)] border-[#EFE4CD]' : 'border-transparent hover:bg-[rgba(219,179,88,0.1)] hover:border-[#EFE4CD]' }}">
                        <div class="flex items-center gap-4">
                            <div class="w-5 flex justify-center">
                ...
                <li>
                    <a href="{{ route('page.privacy') }}"
                        class="flex items-center justify-between w-full h-[68px] px-4 rounded-[10px] text-[#1A1A1A] font-['Outfit'] text-[15px] font-medium group transition-colors box-border border {{ request()->routeIs('page.privacy') ? 'bg-[rgba(219,179,88,0.1)] border-[#EFE4CD]' : 'border-transparent hover:bg-[rgba(219,179,88,0.1)] hover:border-[#EFE4CD]' }}">
                        <div class="flex items-center gap-4">
                            <div class="w-5 flex justify-center">
